        ...
        if ($result->num_rows > 0) {
            ...
            while ($row = $result->fetch_assoc()) {
                echo '<tr>
                        ...
                        <td>
                            <a class="btn btn-primary btn-sm" href="editarestudiante.php?id=' . urlencode($row['Dni']) . '">Editar</a>
                            <a class="btn btn-danger btn-sm" href="deleteestudiante.php?id=' . urlencode($row['Dni']) . '" onclick="return confirm(\'¿Estás seguro de que quieres eliminar este estudiante?\');">Eliminar</a>
                        </td>
                      </tr>';
            }
            ...
            echo '<p>No hay estudiantes en la base de datos.</p>';
        }
