                ...
                <div class="bloque_sesion">
                    <div class="dropdown-center" style="background-color: black;">
                        ...
                        <ul class="dropdown-menu" style="background-color: black; border-color: grey;">
                          <li><a class="dropsdow-item" href="<?php echo BASE_URL; ?>/contactos"><font style="vertical-align: inherit; color: white;"><font style="vertical-align: inherit;">Mi cuenta</font></font></a></li>
